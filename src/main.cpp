...
const string strMessageMagic = "CircleCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CircleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 21 Dec 2014 12:57:19 GMT";
        CTransaction txNew;
        txNew.nTime = 1419166639;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1419166641;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1934641;
		if(fTestNet)
        {
            block.nNonce   = 1934641;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x74645be862b67dcab64a3ca41902067b5904a291270eaa2d5a88eb282a026bc4"));
        block.print();
